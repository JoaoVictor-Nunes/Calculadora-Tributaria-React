...
// Modal que exibe calculadora de tributação para Pessoa Jurídica
const ModalCalculoPJ = () => {
    ...
    return (
        <div>
            {/* BOTÃO QUE ABRE O MODAL - PESSOA JURÍDICA */}
            <Button
                onClick={handleOpen}
                size="large"
                startIcon={<AccountBalanceIcon />} // Ícone de banco/balanço (representa PJ)
                sx={{
                    color: colors.grey[900], // Texto escuro para contraste
                    backgroundColor: colors.redAccent[500], // Fundo vermelho (consistente com PF)
            ...
            >
                ...
                >
                    <Box sx={style}>
                        {/* TÍTULO DO MODAL - PESSOA JURÍDICA */}
                        <Typography
                            id="tituloModalPJ"
                            variant="h5"
                            component="h2"
